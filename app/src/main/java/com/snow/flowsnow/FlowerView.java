...
public class FlowerView extends View {
    ...
    MyFlower flowers [] = new MyFlower[60];
    ...
    public void setWH(int pW, int pH, float de){
        ...
        this.mH = pH;
        this.de = de;
        offsetX = new Integer[]{(int)(2*de), (int)(-2*de), (int)(-1*de), 0, (int)(1*de), (int)(3*de), (int)(-3*de)};
        offsetY = new Integer[]{(int)(4*de), (int)(5*de), (int)(5*de), (int)(3*de), (int)(4*de)};
    }
